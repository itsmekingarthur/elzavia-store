...
const defaultTestimonials: Testimonial[] = [
  { id: "1", name: "محمد", text: "منتجات رائعة، حسيت بالفرق من أول أسبوع. الطاقة صارت أفضل والتركيز في العمل تطور بشكل ملحوظ.", from: "الدار البيضاء" },
  { id: "2", name: "سارة", text: "جودة ممتازة وتوصيل سريع جداً. الطلب وصل في أقل من 24 ساعة. أنصح بالتجربة.", from: "الرباط" },
  { id: "3", name: "أحمد", text: "بعد استخدام كبسولات التعافي العضلي، لاحظت فرق كبير في التمرين. منتج طبيعي وآمن.", from: "مراكش" },
];
