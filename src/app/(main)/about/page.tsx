          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.step} className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 text-center hover:border-primary-500/20 transition-all duration-300">
                  <div className="w-10 h-10 rounded-xl bg-primary-500/20 text-primary-400 flex items-center justify-center font-extrabold text-sm mx-auto mb-4">{item.step}</div>
            ...
            <div className="text-center mt-12">
              <Link href="/shop" className="btn-nature inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-base shadow-lg shadow-primary-500/20">
                تسوق الآن
