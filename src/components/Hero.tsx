...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800">
      <div className="absolute inset-0 bg-grid opacity-40" />

      <div className="absolute -top-40 -right-40 w-80 md:w-[40rem] h-80 md:h-[40rem] bg-primary-500/20 rounded-full blur-[120px] animate-pulse-soft" />
      <div className="absolute -bottom-40 -left-40 w-80 md:w-[40rem] h-80 md:h-[40rem] bg-gold-500/15 rounded-full blur-[120px] animate-pulse-soft" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 md:py-40">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/10 rounded-full px-4 py-2 mb-6 md:mb-8">
            ...
            <span className="text-gold-300 text-xs md:text-sm font-medium">مكملات طبيعية 100%</span>
          </div>
          ...
          <div className="flex flex-wrap gap-3 md:gap-4">
            <Link
              href="/shop"
              className="btn-gold text-base md:text-lg px-8 md:px-10 py-3.5 md:py-4 flex items-center gap-2 group"
            >
              تسوق الآن
